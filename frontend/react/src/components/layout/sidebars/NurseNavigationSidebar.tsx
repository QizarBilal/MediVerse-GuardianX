...
interface NurseNavigationSidebarProps {
  activeTab: string;
...
const NurseNavigationSidebar: React.FC<NurseNavigationSidebarProps> = ({ activeTab, setActiveTab, isOpen, setIsOpen }) => {
...
export default NurseNavigationSidebar;
