...
const DoctorDashboardView: React.FC<DoctorDashboardViewProps> = ({ activeTab, setActiveTab }) => {
  const { user } = useAuth();
          ...
          <div className="p-6">
            <div className="space-y-4">
              {doctorPrescriptions.slice(0, 5).map((prescription) => (
                <div key={prescription.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-700 rounded-lg">
